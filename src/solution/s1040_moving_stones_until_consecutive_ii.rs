...
impl Solution {
    // Credit: https://leetcode.com/problems/moving-stones-until-consecutive-ii/solutions/3034374/just-a-runnable-solution/
...
mod tests {
    ...
    #[test]
    fn test_1040_example_1() {
        let stones = vec![7, 4, 9];
        let result = vec![1, 2];

        assert_eq!(Solution::num_moves_stones_ii(stones), result);
    }

    #[test]
    fn test_1040_example_2() {
