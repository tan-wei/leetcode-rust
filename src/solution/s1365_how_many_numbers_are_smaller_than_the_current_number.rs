...
mod tests {
    ...
    #[test]
    fn test_1365_example_1() {
        let nums = vec![8, 1, 2, 2, 3];

        let result = vec![4, 0, 1, 1, 3];

        assert_eq!(Solution::smaller_numbers_than_current(nums), result);
    }

    #[test]
    fn test_1365_example_2() {
        let nums = vec![6, 5, 4, 8];

        let result = vec![2, 1, 0, 3];

        assert_eq!(Solution::smaller_numbers_than_current(nums), result);
    }

    #[test]
    fn test_1365_example_3() {
