...
mod tests {
    ...
    #[test]
    fn test_0480_example_1() {
        let nums = vec![1, 3, -1, -3, 5, 3, 6, 7];
        let k = 3;
        let result = vec![1.00000, -1.00000, -1.00000, 3.00000, 5.00000, 6.00000];

        assert_eq!(Solution::median_sliding_window(nums, k), result);
    }

    #[test]
    fn test_0480_example_2() {
