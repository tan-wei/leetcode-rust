...
struct TweetCounts {
    tweets: std::collections::HashMap<String, Vec<i32>>,
}
...
mod tests {
    ...
    #[test]
    fn test_1348_example_1() {
        let mut tweet_counts = TweetCounts::new();
        tweet_counts.record_tweet("tweet3".to_string(), 0); // New tweet "tweet3" at time 0
        tweet_counts.record_tweet("tweet3".to_string(), 60); // New tweet "tweet3" at time 60
        tweet_counts.record_tweet("tweet3".to_string(), 10); // New tweet "tweet3" at time 10
        ...
        tweet_counts.record_tweet("tweet3".to_string(), 120); // New tweet "tweet3" at time 120
