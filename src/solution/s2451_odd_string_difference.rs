...
impl Solution {
    pub fn odd_string(words: Vec<String>) -> String {
        ...
        let f = |(count, word): (i32, String)| (count == 1).then(|| word);
...
mod tests {
    ...
    #[test]
    fn test_2451_example_1() {
        let words = vec_string!["adc", "wzy", "abc"];

        let result = "abc".to_string();

        assert_eq!(Solution::odd_string(words), result);
    }

    #[test]
    fn test_2451_example_2() {
        let words = vec_string!["aaa", "bob", "ccc", "ddd"];
