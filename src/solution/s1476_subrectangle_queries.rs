...
mod tests {
    ...
    #[test]
    fn test_1476_example_1() {
        let mut subrectangle_queries =
            SubrectangleQueries::new(vec![vec![1, 1, 1], vec![2, 2, 2], vec![3, 3, 3]]);
        assert_eq!(subrectangle_queries.get_value(0, 0), 1);
        subrectangle_queries.update_subrectangle(0, 0, 2, 2, 100);
        assert_eq!(subrectangle_queries.get_value(0, 0), 100);
        assert_eq!(subrectangle_queries.get_value(2, 2), 100);
        subrectangle_queries.update_subrectangle(1, 1, 2, 2, 20);
        assert_eq!(subrectangle_queries.get_value(2, 2), 20);
    }
}
