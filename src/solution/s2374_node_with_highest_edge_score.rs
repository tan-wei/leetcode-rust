...
impl Solution {
    // Credit: https://leetcode.com/problems/node-with-highest-edge-score/solutions/2449611/rust-solution-by-bigmih-9gz6/
...
mod tests {
    ...
    #[test]
    fn test_2374_example_1() {
        let edges = vec![1, 0, 0, 0, 0, 7, 7, 5];

        let result = 7;

        assert_eq!(Solution::edge_score(edges), result);
    }

    #[test]
    fn test_2374_example_2() {
        let edges = vec![2, 0, 0, 2];
