...
mod tests {
    ...
    #[test]
    fn test_1018_example_1() {
        let nums = vec![0, 1, 1];
        let result = vec![true, false, false];

        assert_eq!(Solution::prefixes_div_by5(nums), result);
    }

    #[test]
    fn test_1018_example_2() {
        let nums = vec![1, 1, 1];
        let result = vec![false, false, false];
