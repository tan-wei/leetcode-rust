    ...
    pub fn get_maximum_generated(n: i32) -> i32 {
        ...
        for i in 2..=n {
            if i % 2 == 0 {
                ...
                v.push(v[(k * 2) / 2 as usize] + v[((k * 2) / 2 + 1) as usize]);
                k += 1;
            }
        }
...
mod tests {
    ...
    #[test]
    fn test_1646_example_1() {
        let n = 7;

        let result = 3;

        assert_eq!(Solution::get_maximum_generated(n), result);
    }

    #[test]
    fn test_1646_example_2() {
        let n = 2;
