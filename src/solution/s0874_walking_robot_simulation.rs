...
impl Solution {
    // Credit: https://leetcode.com/problems/walking-robot-simulation/solutions/882711/rust-translated-12ms-100/
            ...
            if cmd == -2 {
                ...
                for k in 0..cmd {
                    ...
                    if !set.contains(&(nx, ny)) {
                        x = nx;
                        y = ny;
                        result = std::cmp::max(result, x * x + y * y);
                    }
                }
            }
        }
...
mod tests {
    ...
    #[test]
    fn test_0874_example_1() {
        let commands = vec![4, -1, 3];
        let obstacles = vec![];
        let result = 25;

        assert_eq!(Solution::robot_sim(commands, obstacles), result);
    }

    #[test]
    fn test_0874_example_2() {
