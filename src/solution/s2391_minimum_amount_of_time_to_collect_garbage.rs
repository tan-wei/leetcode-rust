...
mod tests {
    ...
    #[test]
    #[ignore]
    fn test_2391_example_1() {
        let garbage = vec_string!["G", "P", "GP", "GG"];
        let travel = vec![2, 4, 3];

        let result = 21;

        assert_eq!(Solution::garbage_collection(garbage, travel), result);
    }

    #[test]
    #[ignore]
    fn test_2391_example_2() {
        let garbage = vec_string!["MMM", "PGM", "GP"];
        let travel = vec![3, 10];
