...
mod tests {
    ...
    #[test]
    #[ignore]
    fn test_2580_example_1() {
        let ranges = vec![vec![6, 10], vec![5, 15]];

        let result = 2;

        assert_eq!(Solution::count_ways(ranges), result);
    }

    #[test]
    #[ignore]
    fn test_2580_example_2() {
        let ranges = vec![vec![1, 3], vec![10, 20], vec![2, 5], vec![4, 8]];
