...
mod tests {
    ...
    #[test]
    fn test_1366_example_1() {
        let votes = vec_string!["ABC", "ACB", "ABC", "ACB", "ACB"];

        let result = "ACB".to_string();

        assert_eq!(Solution::rank_teams(votes), result);
    }

    #[test]
    fn test_1366_example_2() {
        let votes = vec_string!["WXYZ", "XYZW"];

        let result = "XWYZ".to_string();

        assert_eq!(Solution::rank_teams(votes), result);
    }

    #[test]
    fn test_1366_example_3() {
        let votes = vec_string!["ZMNAGUEDSJYLBOPHRQICWFXTVK"];

        let result = "ZMNAGUEDSJYLBOPHRQICWFXTVK".to_string();
