    ...
    pub fn slowest_key(release_times: Vec<i32>, keys_pressed: String) -> char {
        ...
        release_times
            ...
            .fold(0, |t_prev, (&t_cur, c)| {
                ...
                if delay > max_time || delay == max_time && c > reslut {
                    reslut = c;
                    max_time = delay;
                }
                t_cur
...
mod tests {
    ...
    #[test]
    fn test_1629_example_1() {
        let release_times = vec![9, 29, 49, 50];
        let keys_pressed = "cbcd".to_string();

        let result = 'c';

        assert_eq!(Solution::slowest_key(release_times, keys_pressed), result);
    }

    #[test]
    fn test_1629_example_2() {
