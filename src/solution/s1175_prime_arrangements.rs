...
impl Solution {
    pub fn num_prime_arrangements(n: i32) -> i32 {
        ...
        ((1..=num_primes).fold(1, |acc, x| acc * x % 1_000_000_007)
            * (1..=n as usize - num_primes).fold(1, |acc, x| acc * x % 1_000_000_007)
...
mod tests {
    ...
    #[test]
    fn test_1175_example_1() {
        let n = 5;
        let result = 12;

        assert_eq!(Solution::num_prime_arrangements(n), result);
    }

    #[test]
    fn test_1175_example_2() {
        let n = 100;
        let result = 682289015;
