...
mod tests {
    ...
    #[test]
    fn test_0165_example_1() {
        let version1 = "1.01".to_string();
        let version2 = "1.001".to_string();
        let result = 0;

        assert_eq!(Solution::compare_version(version1, version2), result);
    }

    #[test]
    fn test_0165_example_2() {
