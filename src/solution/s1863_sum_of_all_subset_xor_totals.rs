...
impl Solution {
    pub fn subset_xor_sum(nums: Vec<i32>) -> i32 {
        nums.iter().fold(0x0, |result, x| result | x) << nums.len() - 1
    }
}
...
mod tests {
    ...
    #[test]
    fn test_1863_example_1() {
        let nums = vec![1, 3];

        let result = 6;

        assert_eq!(Solution::subset_xor_sum(nums), result);
    }

    #[test]
    fn test_1863_example_2() {
        let nums = vec![5, 1, 6];
